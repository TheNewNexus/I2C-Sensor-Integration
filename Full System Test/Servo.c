...
void Servo_Init(void){
	SYSCTL_RCGCGPIO_R |= EN_PWM0_GPIOB_CLOCK;				//Activate GPIOB Clock
	while((SYSCTL_PRGPIO_R & EN_PWM0_GPIOB_CLOCK) != EN_PWM0_GPIOB_CLOCK);
	...
	*/
	...
	SYSCTL_RCC_R |= SYSCTL_RCC_PWMDIV_8;				//Set PWM Divider to 8
